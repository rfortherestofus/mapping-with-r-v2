...
- Import data on Portland sextants from `https://raw.githubusercontent.com/rfortherestofus/mapping-with-r-v2/refs/heads/main/data/portland_sextants.geojson`

- Join the data on traffic signals from the last lesson with the sextants data to see how many traffic signals are in each sextant
