...
- Run the following code in order to import an `sf` object called `africa`. You'll need to install the {sf} package if you don't already have it installed.
...
africa <-
  read_sf("https://raw.githubusercontent.com/rfortherestofus/mapping-with-r-v2/refs/heads/main/data/africa.geojson")
```
