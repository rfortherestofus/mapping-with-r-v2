...
## Mapping Data to Aesthetic Properties with {leaflet} Maps {.inverse}

<!-- {{< include slides-mapping-data-to-aesthetic-properties-with-leaflet-maps.qmd >}} -->
...
<!-- {{< include slides-making-bubble-maps-with-leaflet.qmd >}} -->
